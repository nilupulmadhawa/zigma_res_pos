  ...
  <div class="">
    <div class="col-md-12 pl-0 pr-0">
        ...
        <div class="d-flex">
          <div class="mr-4">
            <span class="text-title">
              {{ $t("Register") }}
              {{
                register_data_basic.billing_counter["billing_counter_code"]
              }}
              - {{ register_data_basic.billing_counter["counter_name"] }}</span
            >
          </div>
        </div>
        <div class="ml-auto">
          <button
            ...
            v-on:click="printnode_print('BUSINESS_REGISTER_REPORT')"
      ...
      <div class="d-flex mb-4">
        <iframe
          class="pdf_iframe"
          title="Register Summary Print PDF"
          :src="pdf_print"
        ></iframe>
      </div>
    </div>
