...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            calculate_tax(item_total, tax_percentage, inclusive = false){
                var tax_amount = 0;
                if(inclusive === true){
                    tax_amount = parseFloat(item_total) - (parseFloat(item_total)/(1+(parseFloat(tax_percentage)/100)));
                }else{
                    tax_amount = (parseFloat(tax_percentage)/100)*parseFloat(item_total);
                }
            ...
            calculate_sale_prices(){
                if(this.is_taxcode_inclusive == true){
                    var calculated_tax = this.calculate_tax(this.sale_price_including_tax, this.selected_tax_percentage, true);
