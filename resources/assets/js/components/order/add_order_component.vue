  ...
  <div class="row m-0">
    <div class="col-md-8 p-0 bg-white border-right">
      <div class="p-0 border-bottom">
        <div
          class="d-flex flex-nowrap justify-content-between p-3 horizontal-scroll hide-horizontal-scroll"
        >
          ...
          <button
            ...
            v-on:click="get_keyboard_shortcuts()"
          ...
          >
            ...
            >
              <option
                v-for="(billing_types_item, index) in billing_types"
                v-bind:value="billing_types_item.billing_type_constant"
                v-bind:key="index"
              >
          ...
          <button
            class="btn btn-outline-dark ml-3 text-nowrap"
            v-on:click="get_digital_menu_orders_list(1)"
            v-if="store_restaurant_mode == true"
          >
          ...
          <button
            class="btn btn-outline-dark ml-3 text-nowrap"
            v-on:click="get_running_orders_list(1)"
            v-if="store_restaurant_mode == true"
          >
            {{ $t("Running Orders") }}
          </button>
          ...
          <button
            ...
            v-on:click="close_register"
          >
            <i class="fas fa-cash-register"></i>&ensp;<span
              v-if="parent_register == 1"
              >{{ $t("Close Register") }}</span
            ><span v-else>{{ $t("Exit Register") }}</span>
          </button>
        </div>
      </div>
        ...
        <form @submit.prevent="product_info_form">
          <div class="form-row mb-2">
            ...
            <div class="form-group col-md-3">
              <button
                type="submit"
                class="btn btn-primary btn-block btn-lg find-product-btn"
                v-bind:disabled="product_processing == true"
              >
                <i
                  class="fa fa-circle-notch fa-spin"
                  v-if="product_processing == true"
                ></i>
                {{ $t("Go") }}
              </button>
            </div>
          ...
          <div class="form-row d-flex overflow-auto">
            ...
            >
              <input
                ...
                name="waiter"
                v-model="category"
                v-bind:value="category_item.slack"
      ...
      <div class="d-flex flex-wrap mb-5 p-3 product-list bg-light">
        <div class="col-md-12">
          <div class="row">
            <div
              class="d-flex align-items-start flex-column p-1 mb-1 col-md-4 bg-light product"
            ...
            >
              ...
              >
                <div
                  ...
                  v-if="product_list_item.images.length > 0"
                >
                  <img
                    :src="
                ...
                <div class="text-bold text-break overflow-hidden product-title">
                  ...
                  <span
                    ...
                    v-if="
                      ...
                      Object.keys(product_list_item.variants_by_options_pos)
                        .length > 0
                    "
                ...
                >
                  <span class="text-warning text-caption"
                    >Only {{ product_list_item.quantity }} stock(s) left</span
                  >
                </div>
                <div
                  class="text-bold text-break overflow-hidden"
      ...
      <div class="cart_form border-left">
        <div class="p-0 border-bottom">
          <div class="d-flex flex-wrap p-3 align-items-center">
            <span class="mr-auto text-title text-black-50">{{
              $t("Cart")
            }}</span>
            <button
              class="btn btn-outline-primary"
              v-on:click="show_customer_modal = true"
            >
        ...
        <div class="p-0 cart-list">
          <div
            ...
            v-for="(cart_item, key, index) in cart"
            v-bind:value="cart_item.product_slack"
            v-bind:key="index"
          >
            <div class="d-flex mb-2">
              <span class="small text-secondary"
                >{{ $t("Product Code") }} : {{ cart_item.product_code }}</span
              >

              <button
                type="button"
                v-on:click="remove_from_cart(key)"
            ...
            <div
              class="d-flex flex-row justify-content-between mr-2 cart-item-summary"
            >
              <div class="">
            ...
            >
              ...
              <div
                class="d-flex flex-row justify-content-between mr-2 cart-item-addon"
                v-for="(
                  addon_cart_item, key, index
                ) in cart_item.selected_addon_products"
                v-bind:value="addon_cart_item.product_slack"
                v-bind:key="index"
              >
                <div class="">
                  <div class="d-flex flex-column">
                    <div class="">
                      ...
                      <span class="text-secondary"
                        >{{ $t("Price") }}: {{ addon_cart_item.price }}</span
                      >
                      &#8226;
                      <span
                        v-if="
            ...
            <button
              type="button"
              v-on:click="show_addon_groups(key, cart_item.product_slack)"
        ...
        <div
          class="d-flex flex-column p-3 ml-auto fixed-bottom col-md-4 border-top cart-summary"
        >
          <div
            class="d-flex justify-content-center show-more-billing-data bg-white cursor"
            v-on:click="toggle_calculation"
          >
            <span class="show-more-billing-data-text">
              <span v-if="toggle_calculation_data == 0"
                ><i
                  class="fas fa-angle-double-up show-more-billing-data-icon"
                ></i>
                Show more</span
              >
              <span v-else
                ><i
                  class="fas fa-angle-double-down show-more-billing-data-icon"
                ></i>
                Show less</span
              >
            </span>
          ...
          <div v-show="toggle_calculation_data == 1">
            <div
              class="d-flex justify-content-between mb-2 cart-summary-label mt-0"
            >
    ...
    <modalcomponent
      v-show="show_customer_modal"
      v-on:close="show_customer_modal = false"
      ref="customer"
    >
        ...
        <div v-if="customer == null">
          <div class="form-group">
            ...
            <cool-select
              ...
              class=""
              :placeholder="$t('Name or Email or Contact No.')"
              autocomplete="off"
              :items="customer_list"
              item-text="fullname"
              itemValue="slack"
              ...
              @search="load_customers($event, 'all')"
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-validate="'max:255'"
              class="form-control"
              :placeholder="$t('Please provide Name')"
              autocomplete="off"
            />
          ...
          <div class="d-flex justify-content-center p-2">
            <span
              class="text-primary text-bold cursor"
              v-on:click="new_customer_form()"
          ...
          <addcustomerordercomponent
            v-show="show_new_customer_form == true"
            v-bind:class="'mt-2 border-top'"
        ...
        <div v-else>
          <div class="">
            <div class="d-flex justify-content-center mb-2">
              <img
                src="/images/customer_default.svg"
            ...
            <div class="d-flex justify-content-center mt-4 mb-2">
              <span
                class="text-danger text-bold cursor"
                v-on:click="dismiss_customer()"
                ><i class="fas fa-times-circle fa-2x align-bottom"></i>
                Remove</span
              >
            </div>
          </div>
      ...
      <template v-slot:modal-footer>
        <button
          type="button"
          class="btn btn-light"
          v-shortkey="keyboard_shortcuts_formatted.SKIP_CUSTOMER"
    ...
    <modalcomponent
      v-show="show_creation_modal"
      v-on:close="show_creation_modal = false"
    ...
    >
      ...
      <template v-slot:modal-body>
        <p
          v-show="server_errors"
          v-html="server_errors"
          ...
          <div v-if="order_status == 'CLOSE'">
            <div class="form-group">
              ...
              <small id="business_account_help" class="form-text text-muted"
                >Transaction will be saved under this account</small
              >
              <span
                v-bind:class="{
            ...
            <div class="form-row mb-2" v-if="show_balance_calc_form">
              <div class="form-group col-md-4">
                ...
                <input
                  type="number"
                  name="calc_received_amount"
                  v-model="calc_received_amount"
                  class="form-control form-control-lg"
              ...
              <div class="form-group col-md-4">
                ...
                <input
                  type="number"
                  name="calc_order_amount"
                  v-model="calc_order_amount"
                  class="form-control form-control-lg"
              ...
              <div class="form-group col-md-4">
                ...
                <input
                  type="number"
                  name="calc_balance_amount"
                  v-model="calc_balance_amount"
                  class="form-control form-control-lg"
            ...
            <div class="form-group col-md-12 p-0">
              ...
              <div class="d-flex flex-wrap">
                ...
                >
                  <div
                    class="col-md-3"
                    v-for="(waiter_user, index) in waiters"
                    v-bind:key="index"
                  >
                    <input
                      type="radio"
                      ...
                      name="waiter"
                      v-model="waiter"
                      v-bind:value="waiter_user.slack"
                      v-bind:id="'waiter' + index"
                    />
                    <label
                      class="check-buttons w-100 text-truncate"
                      v-bind:for="'waiter' + index"
                    ...
                    >
                      ...
                      <label
                        ...
                        <span class="float-right" title="No of Occupants"
                          ...
                          {{ vacant_table.no_of_occupants }}</span
                        ></label
                      >
                    </div>
                  </div>
    ...
    <modalcomponent
      v-if="show_close_register_modal"
      v-on:close="show_close_register_modal = false"
    >
      <template v-slot:modal-header v-if="parent_register == 1">{{
        $t("Close Register")
      }}</template>
      <template v-slot:modal-header v-else>{{ $t("Exit Register") }}</template>
      <template v-slot:modal-body>
        <p
          v-html="close_register_server_errors"
          v-bind:class="[error_class]"
        ></p>
          ...
          <div>
            <div class="form-group">
              ...
              <input
                ...
                :placeholder="$t('Please provide total cash')"
                autocomplete="off"
              />
              <span
                v-bind:class="{
            ...
            <div class="form-group">
              ...
              <input
                ...
                v-validate="'decimal|min_value:0'"
                class="form-control form-control-custom"
                :placeholder="$t('Please provide total credit card slips')"
                autocomplete="off"
              />
              <span
                v-bind:class="{
            ...
            <div class="form-group">
              ...
              <input
                ...
                v-validate="'decimal|min_value:0'"
                class="form-control form-control-custom"
                :placeholder="$t('Please provide total cheques')"
                autocomplete="off"
              />
              <span
                v-bind:class="{
        ...
        Are you sure you want to <span v-if="parent_register == 1">close</span
        ><span v-else>exit</span> register?
      </template>
      <template v-slot:modal-footer>
        <div v-if="register_amount_processing == true">
          <span class="" v-if="register_amount_processing == true"
            ><i
              class="fa fa-circle-notch fa-spin"
              v-if="register_amount_processing == true"
            ></i>
    ...
    <modalcomponent
      v-if="show_addon_group_modal"
      v-on:close="show_addon_group_modal = false"
    ...
    >
      ...
      <template v-slot:modal-body>
        <div v-if="addon_product_group_processing == true">
          <span class="" v-if="addon_product_group_processing == true"
            ><i
              class="fa fa-circle-notch fa-spin"
              v-if="addon_product_group_processing == true"
            ></i>
        ...
        <div v-else>
          <div
            ...
            ) in choosed_addon_product_group"
            v-bind:key="index"
          >
            ...
            <div class="mb-2">
              <div
                ...
                ) in choosed_addon_product_group_item.products"
                v-bind:key="index"
              >
                <input
                  :class="
                  ...
                  "
                  v-model="selected_addon_slack_array"
                  :value="choosed_addon_product.product['slack']"
                  v-on:click="
                ...
                <span class="float-right">{{
                  choosed_addon_product.product["sale_amount_excluding_tax"]
                }}</span>
              </div>
            </div>
          </div>
      ...
      <template v-slot:modal-footer>
        ...
        <div v-else>
          ...
          <button
            type="button"
            class="btn btn-primary"
            @click="add_addon_to_product(product_slack)"
          >
            Update Cart
          </button>
        </div>
    ...
    <modalcomponent
      v-if="show_variant_modal"
      v-on:close="show_variant_modal = false"
      :modal_width="'modal-container-xl'"
    >
      <template v-slot:modal-header>
        {{ $t("Choose Variant") }}
      ...
      <template v-slot:modal-body>
        <div
          ...
          v-if="selected_variant_keys.length > 1"
        >
          <span class="mr-3">Jump to</span>
          <div
            class="mr-2"
            v-for="(selected_variant_key, option) in selected_variant_keys"
            :key="option"
          >
        ...
        <div
          ...
          v-for="(selected_variant_list_item, option) in selected_variant_list"
          :key="option"
          :id="option"
        >
          <div class="mb-1">
          ...
          <div class="d-flex flex-wrap mb-1">
            <div class="col-md-12">
              <div class="row">
                <div
                  class="d-flex align-items-start p-1 mb-1 col-md-4 product"
                  v-for="(
                    variant_product_list_item, index
                  ) in selected_variant_list_item"
                  v-bind:value="variant_product_list_item.product.slack"
                  v-bind:key="index"
                  v-on:click="add_to_cart(variant_product_list_item.product)"
                >
                  <div
                    class="col-12 p-3 bg-white product-grid h-100"
                    v-shortkey="{
                      left: [keyboard_shortcuts_formatted.ARROW_LEFT],
                      right: [keyboard_shortcuts_formatted.ARROW_RIGHT],
                      choose: [keyboard_shortcuts_formatted.CHOOSE_PRODUCT],
                  ...
                  >
                    ...
                    <div
                      class="text-bold text-break overflow-hidden product-title"
                    >
                      {{
    ...
    <quickpanelcomponent
      v-show="show_running_order_quickpanel"
      v-on:close-quick-panel="show_running_order_quickpanel = false"
    ...
    >
      ...
      <template v-slot:quick-panel-body>
        <span class="" v-if="running_order_list_processing == true"
          ><i
            class="fa fa-circle-notch fa-spin"
            v-if="running_order_list_processing == true"
          ></i>
          Loading..</span
        >
        ...
        <div v-show="running_order_list_processing == false">
          <input
            ...
            :placeholder="$t('Search by order, customer, table..')"
            autocomplete="off"
          />
          ...
          <div v-if="running_order_list_filtered.length > 0">
            <div
              ...
              ) in running_order_list_filtered"
            ...
            >
              <div class="d-flex justify-content-between mb-2">
                ...
                <div class="ml-auto">
                  <span
                    v-if="running_order_list_item.kitchen_status != null"
    ...
    <quickpanelcomponent
      v-show="show_hold_list_modal"
      v-on:close-quick-panel="show_hold_list_modal = false"
      :panel_class="'col-md-6 col-xl-3'"
    >
      <template v-slot:quick-panel-header>
      ...
      <template v-slot:quick-panel-body>
        <span class="" v-if="hold_list_processing == true"
          ><i
            class="fa fa-circle-notch fa-spin"
            v-if="hold_list_processing == true"
          ></i>
          Loading..</span
        >
        ...
        <div v-show="hold_list_processing == false">
          <input
            type="text"
            v-model="search_hold_list"
            class="form-control form-control-custom mb-3"
            :placeholder="$t('Search by order, customer ..')"
            autocomplete="off"
          />
          ...
          <div v-if="hold_list_filtered.length > 0">
            <div
              class="list-item mb-3"
              v-for="(hold_order_list_item, key, index) in hold_list_filtered"
              v-bind:key="index"
              v-on:click="
                go_to_order(
    ...
    <quickpanelcomponent
      v-show="show_keyboard_shortcuts_quickpanel"
      v-on:close-quick-panel="show_keyboard_shortcuts_quickpanel = false"
      :panel_class="'col-md-6 col-xl-3'"
    >
      <template v-slot:quick-panel-header>
    ...
    <quickpanelcomponent
      v-show="show_digital_menu_order_quickpanel"
      v-on:close-quick-panel="show_digital_menu_order_quickpanel = false"
      :panel_class="'col-md-6 col-xl-3'"
    >
      <template v-slot:quick-panel-header>
      ...
      <template v-slot:quick-panel-body>
        <span class="" v-if="digital_menu_order_list_processing == true"
          ><i
            class="fa fa-circle-notch fa-spin"
            v-if="digital_menu_order_list_processing == true"
          ></i>
          Loading..</span
        >
        ...
        <div v-show="digital_menu_order_list_processing == false">
          <input
            type="text"
            v-model="search_digital_menu_list"
            class="form-control form-control-custom mb-3"
            :placeholder="$t('Search by order, customer, table..')"
            autocomplete="off"
          />
          ...
          <div v-if="digital_menu_order_list_filtered.length > 0">
            <div
              ...
              ) in digital_menu_order_list_filtered"
              v-bind:value="digital_menu_order_list_item.slack"
              v-bind:key="index"
              v-on:click="
                go_to_order(
            ...
            >
              <div class="d-flex justify-content-between mb-2">
                ...
                <div class="ml-auto">
                  <span
                    v-if="digital_menu_order_list_item.kitchen_status != null"
                    v-bind:class="
            ...
            <div class="d-flex justify-content-center pl-4 pr-4">
              <span
                class="text-centered btn-label mt-2"
                v-show="digital_menu_order_has_more_items"
                v-on:click="
  ...
  data() {
    return {
      ...
      restaurant_order_type:
        this.order_data == null ? "" : this.order_data.order["order_type"],
      restaurant_table:
        this.order_data == null ? "" : this.order_data.order["table"],
  ...
  mounted() {
    ...
    if (this.order_data !== null) {
      ...
      this.show_customer_modal =
        this.enable_customer_detail_popup != null
          ? this.enable_customer_detail_popup
          : true;
  ...
  methods: {
            ...
            axios
              ...
              .then((response) => {
                ...
                if (response.data.status_code == 200) {
                  ...
                  if (response.data.print_invoice != "0") {
                    axios
                      .post("http://localhost:8191/print", {
                        pdf_base64: response.data.print_invoice.content ?? "",
                        printer_name: response.data.print_invoice.printer,
                      })
                      .then((res) => {
                  ...
                  if (response.data.print_kot != "0") {
                    axios
                      .post("http://localhost:8191/print", {
                        pdf_base64: response.data.print_kot.content ?? "",
                        printer_name: response.data.print_kot.printer,
                      })
                      .then((res) => {
                        if (res.status == 200) {
                          this.show_response_message(
    ...
    go_to_order(order_status_constant, order_detail_link, order_edit_link) {
      window.location.href =
        order_status_constant == "CLOSED" ? order_detail_link : order_edit_link;
    },
