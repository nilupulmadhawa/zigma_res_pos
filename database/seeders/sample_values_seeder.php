...
class sample_values_seeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $active_stores = StoreModel::select('id', 'slack', 'restaurant_mode', 'currency_code')
        ->active()
        ->orderBy('id', 'asc')
        ->get();
        ...
        if(count($active_stores)>0){
            ...
            foreach ($active_stores as $active_store) {
                ...
                request()->merge([ 'logged_user_store_id' => $active_store->id, 'logged_user_store_slack' => $active_store->slack]);
                ...
                for($j=0; $j<$count; $j++){
                    ...
                    $waiter_user = UserModel::select('slack')->where('email', 'waiter1@test.com')->first();
                    ...
                    $request->merge([
                        ...
                        'logged_user_store_slack' => $active_store->slack,
