    ...
    public function form_po_array($request){
        ...
        foreach($products as $product_key => $product_value){
            ...
            if($tax_type == 'INCLUSIVE'){
                ...
                $tax_amount = calculate_tax($subtotal_amount_including_tax, $tax_percentage, true);
                ...
                $tax_amount = calculate_tax($total_amount_after_discount, $tax_percentage);
            ...
            if(count($tax_components)>0){
                foreach($tax_components as $key => $tax_component){
                    ...
                    $tax_component_amount = calculate_tax($tax_eligible_amount, $tax_component_percentage, ($tax_type == 'INCLUSIVE')?true:false);
