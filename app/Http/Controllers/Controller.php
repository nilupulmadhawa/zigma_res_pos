...
class Controller extends BaseController
{
    ...
    function generate_response($response_array, $type = "")
    {
        ...
        if (isset($response_array['print_kot'])) {
            $response = array_merge($response, array("print_kot" => $response_array['print_kot']));
        }
        if (isset($response_array['print_invoice'])) {
            $response = array_merge($response, array("print_invoice" => $response_array['print_invoice']));
        }
        return $response;
    }
